...
pub func destructure_qualified_aliased(user) {
...
pub func update_qualified(user) {
  one.User(..user, name: "wibble")
}

pub func update_qualified_aliased(user) {
  aliased.User(..user, name: "wibble")
}

pub func update_unqualified(user) {
  User(..user, name: "wibble")
}

pub func update_aliased(user) {
